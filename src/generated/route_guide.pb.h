...
#ifndef route_5fguide_2eproto_2epb_2eh
#define route_5fguide_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:routeguide.RouteSummary) */ {
 public:
  ...
  void operator delete(RouteSummary* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  RouteSummary* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:routeguide.RouteNote) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(RouteNote* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  RouteNote* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:routeguide.Rectangle) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Rectangle* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  Rectangle* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:routeguide.Feature) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Feature* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  Feature* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // route_5fguide_2eproto_2epb_2eh
